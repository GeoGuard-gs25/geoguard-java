...
public class DataBaseSeeder {
    ...
    public void init() {
        ...
        User rafa = User.builder().email("rafao@teste.com").name("Rafael").password(passwordEncoder.encode("78910"))
                .build();
        ...
        notificationRepository.saveAll(List.of(
                Notification.builder()
                        ...
                        .mensagem("Obrigado por se registrar em nossa plataforma. Estamos felizes em ter você conosco!")
                        .lida(false)
                        .build(),
                ...
                Notification.builder()
                        ...
                        .mensagem(
                                "O sistema foi atualizado para a versão 1.2.0. Novas funcionalidades estão disponíveis.")
                        .lida(false)
                        .build(),
                ...
                Notification.builder()
                        ...
                        .mensagem("Seu consumo de energia ultrapassou o limite definido. Verifique sua conta.")
                        .lida(false)
                        .build()));
